...
Acesse o painel do [Supabase](https://app.supabase.com/), vá até **SQL Editor** ou edite o arquivo **init.sql** dentro do diretório Scripts, e rode no terminal **npm run init-db**:
